...
const AccessibleValueHandler = <SuperType extends Constructor>( Type: SuperType, optionsArgPosition: number ) => {
  ...
  return class extends Voicing( Type, optionsArgPosition ) {
    ...
    /* private */
    public _enabledRangeProperty: IReadOnlyProperty<Range>;
    /* private */
    public _startInput: SceneryListenerFunction;
    /* private */
    public _onInput: SceneryListenerFunction;
    /* private */
    public _endInput: SceneryListenerFunction;
    /* private */
    public _constrainValue: ( ( value: number ) => number );
    /* private */
    public _a11yMapValue: ( ( newValue: number, previousValue: number ) => number );
    /* private */
    public _panTargetNode: Node | null;
    /* private */
    public _keyboardStep: number;
    /* private */
    public _shiftKeyboardStep: number;
    /* private */
    public _pageKeyboardStep: number;
    /* private */
    public _ariaOrientation: Orientation;
    /* private */
    public _shiftKey: boolean;

    // track previous values for callbacks outside of Property listeners
    /* private */
    public _oldValue: number | null;

    /* private */
    public _a11yCreateContextResponseAlert: CreateTextFunction | null;
    ...
    /* private */
    public _contextResponseUtterance: Utterance;
    ...
    /* private */
    public _timesValueTextChangedBeforeAlerting: number;

    // in ms, see options for documentation.
    /* private */
    public _contextResponsePerValueChangeDelay: number;
    /* private */
    public _contextResponseMaxDelay: number;
    ...
    /* private */
    public _a11yInputHandled: boolean;
    ...
    /* private */
    public _blockInput: boolean;

    // setting to enable/disable rounding to the step size
    /* private */
    public _roundToStepSize: boolean;

    // key is the event.code for the range key, value is whether it is down
    /* private */
    public _rangeKeysDown: { [ key: string ]: boolean };
    /* private */
    public _a11yMapPDOMValue: ( ( value: number ) => number );
    /* private */
    public _a11yCreateAriaValueText: CreateTextFunction;
    /* private */
    public _dependenciesMultilink: UnknownMultilink | null;
    /* private */
    public _a11yRepeatEqualValueText: boolean;

    // When context responses are supported, this counter is used to determine a mutable delay between hearing the
    // same response.
    /* private */
    public _timesChangedBeforeAlerting: number;

    /* private */
    public _disposeAccessibleValueHandler: () => void;
    ...
    /* private */
    public _getMappedValue( value: number = this._valueProperty.value ): number {
    ...
    /* protected */
    public handleInput( event: SceneryEvent<Event> ): void {
    ...
    /* private */
    public _onInteractionStart( event: SceneryEvent<Event> ): void {
      this._valueOnStart = this._valueProperty.value;
    ...
    /* private */
    public _onInteractionEnd( event: SceneryEvent<Event> ): void {
    ...
    /* private */
    public _updateSiblingStepAttribute(): void {

...
import { AlignBox, AlignBoxOptions, AlignGroup, FlowBox, FlowBoxOptions, IndexedNodeIO, LayoutOrientation, ManualConstraint, Node, NodeOptions, Rectangle, Separator, SeparatorOptions, TPaint } from '../../scenery/js/imports.js';
...
class ScrollingFlowBox extends FlowBox {
  ...
  public override moveChildToIndex( child: Node, index: number ): this {
    super.moveChildToIndex( child, index );
